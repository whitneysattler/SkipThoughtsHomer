    ...
    for ii in iter(range(maxlen)):
        ...
        if stochastic:
            ...
            for idx, [ti, wi] in enumerate(zip(trans_indices, word_indices)):
                new_hyp_samples.append(hyp_samples[int(ti.item())]+[int(wi.item())])
                new_hyp_scores[idx] = copy.copy(costs[idx])
                new_hyp_states.append(copy.copy(next_state[int(ti.item())]))
            ...
            for idx in iter(range(len(new_hyp_samples))):
