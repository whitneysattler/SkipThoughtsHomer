...
#-----------------------------------------------------------------------------#
path_to_model = 'C:/Whitney Masters/Big Data/Project/skip-thoughts/decoding/toy.npz'
path_to_dictionary = 'C:/Whitney Masters/Big Data/Project/skip-thoughts/decoding/dictionary.pkl'
#-----------------------------------------------------------------------------#
...
def load_model():
    ...
    word_idict = dict()
    for kk, vv in iter(worddict.items()):
        word_idict[vv] = kk
    word_idict[0] = '<eos>'
    word_idict[1] = 'UNK'
